        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    cmtBody = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    userName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    blogModelId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_commentD", x => x.Id);
                    table.ForeignKey(
                        name: "FK_commentD_blogModelD_blogModelId",
                        column: x => x.blogModelId,
                        principalTable: "blogModelD",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
